...
public class IssueServiceFilteringTest {
    ...
    public void testTitleFilterOne() {
        ...
        QueryOrder<Issue> queryOrder = new IssueTitleQueryOrder(OrderType.ASCENDENT);
        FilterResult filteredIssues = issueService.filterIssues(filters, queryOrder, 1, 5);
    ...
    public void testOpenStateFilter() {
        IssueStateQueryFilter stateFilter = new IssueStateQueryFilter(IssueState.OPEN);
        List<QueryFilter<Issue>> filters = new ArrayList<>();
    ...
    public void testClosedStateFilter() {
        IssueStateQueryFilter stateFilter = new IssueStateQueryFilter(IssueState.CLOSED);
        List<QueryFilter<Issue>> filters = new ArrayList<>();
        filters.add(stateFilter);
